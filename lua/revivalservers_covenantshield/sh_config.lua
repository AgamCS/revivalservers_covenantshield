...
revivalservers_covShield.config.unstableColor = Color(255, 180, 212) // Color to set the entity to when it goes unstable. Set to nil to disable changing colors
