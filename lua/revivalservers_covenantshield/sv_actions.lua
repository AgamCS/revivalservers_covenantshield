...
function revivalservers_covSheild.UseShield(ply, entity)
    ...
    hook.Add("Move", "covShield_cancelAction", function(pl, mv)
        ...
        if  ( ( mv:GetVelocity() > revivalservers_covShield.cfg.cancelActionVel ) || ( pl:GetPos():DistToSqr(entity:GetPos()) > entity.raidus ) ) && ( timer.Exists(ply:SteamID64() .. " cov_shieldPickup") ) then
            timer.Remove(ply:SteamID64() .. " cov_shieldPickup")
